...
namespace AssetBundles
{
    internal class LaunchAssetBundleServer : ScriptableSingleton<LaunchAssetBundleServer>
    {
        ...
        static void Run()
        {
            ...
            var pathToAssetServer = Path.GetFullPath("Assets/Extensions/AssetBundleManager/Editor/AssetBundleServer.exe");

            if (!File.Exists(pathToAssetServer))
            {
                UnityEngine.Debug.LogError("AssetBundleServer.exe not found!");
                return;
            }
