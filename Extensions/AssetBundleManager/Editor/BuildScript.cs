...
namespace AssetBundles
{
    public class BuildScript
    {
        ...
        static public string CreateAssetBundleDirectory()
        {
            ...
            var outputPath = Path.Combine(Environment.CurrentDirectory, Path.Combine("AssetBundles", Utility.GetPlatformName()));
//            string outputPath = Path.Combine(Application.streamingAssetsPath, Path.Combine(Utility.AssetBundlesOutputPath, Utility.GetPlatformName()));
        ...
        public static void WriteServerURL()
        {
            ...
            string assetBundleManagerResourcesDirectory = "Assets/Extensions/AssetBundleManager/Resources";
            string assetBundleUrlPath = Path.Combine(assetBundleManagerResourcesDirectory, "AssetBundleServerURL.txt");
