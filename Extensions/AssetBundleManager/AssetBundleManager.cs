...
//                Debug.Log("[AssetBundleManager] " + text);
        ...
        static protected void UnloadDependencies(string assetBundleName, bool unloadAllLoadedObjects)
        {
            string[] dependencies = null;
            if (!m_Dependencies.TryGetValue(assetBundleName, out dependencies))
                return;
        ...
        static protected void UnloadAssetBundleInternal(string assetBundleName, bool unloadAllLoadedObjects)
        {
            ...
            if (--bundle.m_ReferencedCount == 0 || unloadAllLoadedObjects)
            {
        ...
        static public AssetBundleLoadAssetOperation LoadAssetAsync(string assetBundleName, string assetName, System.Type type)
        {
...
#endif
            {
                ...
                {
                    Log(LogType.Info, "EXCEPTION " + e.Message + "\n");
                    throw;
                }
